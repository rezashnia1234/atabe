/*! leaflet-routing-machine - v3.0.3 - 2016-06-11 */
...
(function() {
	...
	L.Routing.Itinerary = L.Control.extend({
		...
		options: {
			...
			summaryTemplate: '<h2>{name}</h2><h3 class="route_time">{distance}, {time}</h3>',
			timeTemplate: '{time}',
			containerClassName: '',
		...
		'fa': {
			...
			instructions: {
				...
				'Head':
					['به سمت {dir}', ' در {road}'],
				'Continue':
					['در جهت {dir} ادامه بده', ' در {road}'],
				'SlightRight':
					['به آرامی به راست بچرخید', ' به سمت {road}'],
				'Right':
					['به راست بچرخید', ' به سمت {road}'],
				'SharpRight':
					['سریع به راست بچرخید', ' به سمت {road}'],
				'TurnAround':
					['دور بزنید'],
				'SharpLeft':
					['سریع به چپ بچرخید', ' به سمت ', ' به سمت {road}'],
				'Left':
					['به چپ بچرخید', ' به سمت {road}'],
				'SlightLeft':
					['به آرامی به چپ بچرخید', ' onto {road}'],
				'WaypointReached':
					['به نقطه مورد نظر رسیدید'],
				'Roundabout':
					['از خروجی {exitStr} خارج شوید', ' به سمت {road}'],
				'DestinationReached':
					['به مقصد رسیدید'],
			},
			formatOrder: function(n) {
			...
			ui: {
				startPlaceholder: 'مبداء',
				viaPlaceholder: 'نقطه میانی {viaNumber}',
				endPlaceholder: 'مقصد'
			}
		},
